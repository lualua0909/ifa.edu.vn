...
?>
                <div class="tag-area-container">
                    ...
                    <a class='remove-tag-text' href='#'><img  src='<?php echo get_stylesheet_directory_uri() . '/plugins/tag-manager/images/remove.png'; ?>' alt='' title='<?php _e('Remove Code', 'tag-manager-header-body-footer'); ?>' /></a>
